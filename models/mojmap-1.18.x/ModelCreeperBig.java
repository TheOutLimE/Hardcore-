...
public class ModelCreeperBig<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "creeperbig"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition body = partdefinition.addOrReplaceChild("body", CubeListBuilder.create().texOffs(32, 32)
				.addBox(-8.0F, -36.0F, -2.0F, 16.0F, 24.0F, 8.0F, new CubeDeformation(0.0F)),
				PartPose.offset(0.0F, 24.0F, -2.0F));

		PartDefinition leftleg1 = partdefinition.addOrReplaceChild("leftleg1", CubeListBuilder.create().texOffs(0, 32)
				.addBox(0.0F, -12.0F, -10.0F, 8.0F, 12.0F, 8.0F, new CubeDeformation(0.0F)),
				PartPose.offset(0.0F, 24.0F, -2.0F));

		PartDefinition leftleg2 = partdefinition.addOrReplaceChild("leftleg2", CubeListBuilder.create(),
				PartPose.offset(0.0F, 24.0F, -2.0F));

		PartDefinition cube_r1 = leftleg2
				.addOrReplaceChild("cube_r1",
						CubeListBuilder.create().texOffs(0, 32).addBox(-8.0F, -12.0F, -14.0F, 8.0F, 12.0F, 8.0F,
								new CubeDeformation(0.0F)),
						PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.0F, 3.1416F, 0.0F));

		PartDefinition rightleg1 = partdefinition.addOrReplaceChild("rightleg1", CubeListBuilder.create().texOffs(0, 32)
				.addBox(-8.0F, -12.0F, -10.0F, 8.0F, 12.0F, 8.0F, new CubeDeformation(0.0F)),
				PartPose.offset(0.0F, 24.0F, -2.0F));

		PartDefinition rightleg2 = partdefinition.addOrReplaceChild("rightleg2", CubeListBuilder.create(),
				PartPose.offset(0.0F, 24.0F, -2.0F));

		PartDefinition cube_r2 = rightleg2
				.addOrReplaceChild("cube_r2",
						CubeListBuilder.create().texOffs(0, 32).addBox(0.0F, -12.0F, -14.0F, 8.0F, 12.0F, 8.0F,
								new CubeDeformation(0.0F)),
						PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.0F, 3.1416F, 0.0F));

		PartDefinition head = partdefinition.addOrReplaceChild("head", CubeListBuilder.create().texOffs(0, 0)
				.addBox(-8.0F, -52.0F, -6.0F, 16.0F, 16.0F, 16.0F, new CubeDeformation(0.0F)),
				PartPose.offset(0.0F, 24.0F, -2.0F));
